...
onMounted(() => {
  ...
  if (tooltip) {
    tooltip.formatter = function (params: CallbackDataParams) {
      return `${params.seriesName}的第${params.dataIndex}次计算的值是:${params.value}` || undefined;
